...
[![npm](https://img.shields.io/npm/v/ah-vue-color.svg)](https://www.npmjs.com/package/ah-vue-color)
...
### NPM
```bash
$ npm install ah-vue-color
```

### CommonJS
```js
var Photoshop = require('ah-vue-color/src/Photoshop.vue');
...
### ES6
```js
import { Photoshop } from 'ah-vue-color'
...
### Browser globals
The `dist` folder contains `ah-vue-color.js` and `ah-vue-color.min.js` with all components exported in the <code>window.VueColor</code> object. These bundles are also available on NPM packages.

```html
<script src="path/to/vue.js"></script>
<script src="path/to/ah-vue-color.min.js"></script>
<script>
...
ah-vue-color is licensed under [The MIT License](LICENSE).
